      ...
      <div class="card-header">
        ...
        <form method="POST">
          <div class="input-group mb-3">
            <input type="text" class="form-control" placeholder="Add Category" name="input" id= "name">
            ...
            ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="category.php?update=<?php echo $category['id'] ?>" type="button" class="btn btn-sm btn-primary" name="update" id="update" data-bs-toggle="modal" data-bs-target="#exampleModal" >Update</a>
